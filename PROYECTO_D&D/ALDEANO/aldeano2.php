...
<head>
	<title>ALDEANO</title>
        ...
        body { 
            ...
            background-image: url("imagenes/aldeano.png");
        }
    ...
    <script>
        function comprobar(){
            ...
            if(vidas<=0){
                ...
                //aleatorio=2;
                var paginas=["../bruja/bruja.php","../dragon/dragon.php","../duende/duende.php","../ent/ent.php","../hada/hada.php","../mimico/mimico.php","../orco/orco.php","../viajero/viajero.php"];
