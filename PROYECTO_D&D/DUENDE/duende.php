...
<head>
	<title>DUENDE</title>
        ...
        body { 
            ...
            background-image: url("imagenes/duende.png");
        }
...
<body >
    ...
    $tokens=$_SESSION['tokens'];
            ...
            echo "<div id='texto'><p>Un duende hechicero aparece, quiere destriparte. ¿Que opción eliges?</p></div>";
    ...
    <script>
        function comprobar(){
            ...
            if(vidas<=0){
                ...
                //aleatorio=2;
                var paginas=["../aldeano/aldeano.php","../bruja/bruja.php","../dragon/dragon.php","../ent/ent.php","../hada/hada.php","../mimico/mimico.php","../orco/orco.php","../viajero/viajero.php"];
