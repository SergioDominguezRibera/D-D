...
<head>
	<title>ORCO</title>
        ...
        body { 
            ...
            background-image: url("imagenes/orco.png");
        }
...
<body >
    ...
    $tokens=$_SESSION['tokens'];
            ...
            echo "<div id='texto'><p>Un orco enorme aparece derepente y reclama tu vida. ¿Que opción eliges?</p></div>";
    ...
    <script>
        function comprobar(){
            ...
            if(vidas<=0){
                ...
                //aleatorio=2;
                var paginas=["../aldeano/aldeano.php","../bruja/bruja.php","../dragon/dragon.php","../duende/duende.php","../ent/ent.php","../hada/hada.php","../mimico/mimico.php","../viajero/viajero.php"];
