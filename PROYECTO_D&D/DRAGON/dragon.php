...
<head>
    ...
    <div id="todo">
        <form action="dragon2.php">
            <input type="submit" name="atacar" value="ATACAR" onclick="eliminar()">
            <input type="submit" name="huir" value="HUIR">
...
<body>
    ...
    $tokens=$_SESSION['tokens'];
            ...
            echo "<div id='texto'><p>Notas como aumenta la temperatura, para cuando te das cuenta un dragon te corta el paso. ¿Que opción eliges?</p></div>";
    ...
    <script>
        function comprobar(){
            ...
            if(vidas<=0){
                ...
                //aleatorio=2;
                var paginas=["../aldeano/aldeano.php","../bruja/bruja.php","../duende/duende.php","../ent/ent.php","../hada/hada.php","../mimico/mimico.php","../orco/orco.php","../viajero/viajero.php"];
