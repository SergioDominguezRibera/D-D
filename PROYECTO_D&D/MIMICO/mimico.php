...
<head>
	<title>MIMICO</title>
        ...
        body { 
            ...
            background-image: url("imagenes/mimico.png");
        }
...
<body >
    ...
    $tokens=$_SESSION['tokens'];
            ...
            echo "<div id='texto'>Aparece un cofre en medio del camino, pero era un mímico tendiendote una trampa. ¿Que opción eliges?</div>";
    ...
    <script>
        function comprobar(){
            ...
            if(vidas<=0){
                ...
                //aleatorio=2;
                var paginas=["../aldeano/aldeano.php","../bruja/bruja.php","../dragon/dragon.php","../duende/duende.php","../ent/ent.php","../hada/hada.php","../orco/orco.php","../viajero/viajero.php"];
