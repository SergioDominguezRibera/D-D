...
<head>
	<title>ENT</title>
        ...
        body { 
            ...
            background-image: url("imagenes/ent.png");
        }
...
<body >
    ...
    $tokens=$_SESSION['tokens'];
            ...
            echo "<div id='texto'><p>Mientras caminabas pisas una rama, un Ent se levanta cabreado reclamando venganza. ¿Que opción eliges?</p></div>";
    ...
    <script>
        function comprobar(){
            ...
            if(vidas<=0){
                ...
                //aleatorio=2;
                var paginas=["../aldeano/aldeano.php","../bruja/bruja.php","../dragon/dragon.php","../duende/duende.php","../hada/hada.php","../mimico/mimico.php","../orco/orco.php","../viajero/viajero.php"];
